...
([
    ...
    (function(module, exports, __webpack_require__) {
        ...
        exports.clearInterval = undefined
        exports.clearTimeout = undefined
        exports.setInterval = undefined
        exports.setTimeout = undefined
        ...
        exports.HTMLAudioElement = undefined
        ...
        exports.HTMLAudioElement = _Audio3.HTMLAudioElement

        // 暴露全局的 canvas
        // 小胖.改
        var canvas = GameGlobal._screencanvas || new _Canvas2.default()
    ...
    (function(module, exports, __webpack_require__) {
        ...
        // 小胖.改
        exports.HTMLCanvasElement = exports.HTMLImageElement = exports.HTMLVideoElement = undefined
        ...
        var HTMLImageElement = exports.HTMLImageElement = function(_HTMLElement) {
            var wxImageElement = wx.createImage().constructor;

            return wxImageElement
        }(_HTMLElement4.default)

        // 小胖.改
        var HTMLCanvasElement = exports.HTMLCanvasElement = function(_HTMLElement2) {
            var canvas = GameGlobal._screencanvas || wx.createCanvas();
            GameGlobal._screencanvas = canvas;
            var wxCanvasElement = canvas.constructor;

            return wxCanvasElement
        }(_HTMLElement4.default)

        // 小胖.改
        var HTMLVideoElement = exports.HTMLVideoElement = function(_HTMLElement2) {
            _inherits(HTMLVideoElement, _HTMLElement2)
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var document = {
            ...
            createElementNS: function createElement(nameSpace, tagName) {
